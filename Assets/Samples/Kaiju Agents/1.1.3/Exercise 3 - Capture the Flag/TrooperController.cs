...
namespace KaijuSolutions.Agents.Exercises.CTF
{
    ...
    public class TrooperController : KaijuController
    {
        ...
        private TrooperTree trooperTree;
        ...
        void Start()
        {
            ...
            trooper_agent = GetComponent<KaijuAgent>();

            trooperTree = new TrooperTree(this);
        ...
        private void OnSenseEnemies(TrooperEnemyVisionSensor sensor)
        {
            ...
            foreach (var trooper in sensor.Observed)
            {
                visibleEnemies.Add(trooper);
            }
        }


        public List<Trooper> visibleEnemies = new List<Trooper>();
        public List<Trooper> nearbyTeammates = new List<Trooper>();
        /// <summary>
